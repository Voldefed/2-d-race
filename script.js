...
minSpeed = -1;
maxSpeed = -8;
let enemiesYdy = -5; /*Math.random() * (maxSpeed - minSpeed) + minSpeed;*/
let enemiesYdy2 = -5; /*Math.random() * (maxSpeed - minSpeed) + minSpeed;*/
let enemiesYdy3 = -5; /*Math.random() * (maxSpeed - minSpeed) + minSpeed;*/
let enemiesYdy4 = -5; /*Math.random() * (maxSpeed - minSpeed) + minSpeed;*/
let carHeight = 70;
let carWidth = 70;
